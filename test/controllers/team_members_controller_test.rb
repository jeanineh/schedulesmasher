...
class TeamMembersControllerTest < ActionController::TestCase
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post :create, team_member: { email: @team_member.email, meeting_id: @team_member.meeting_id, name: @team_member.name }
    end
  ...
  test "should update team_member" do
    patch :update, id: @team_member, team_member: { email: @team_member.email, meeting_id: @team_member.meeting_id, name: @team_member.name }
    assert_redirected_to team_member_path(assigns(:team_member))
  end
